"""
Q-Micro :: simulation.market_simulator
------------------------------------------
Orchestrates a default agent population against SyntheticMarketGenerator
over time, with optional regime scheduling.
"""
...
class MarketSimulator:
    def __init__(self, symbol: str = "SYNTH", start_price: float = 100.0, seed: int = 42):
        ...
        self.generator.populate_default_agents()
